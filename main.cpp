...
void loop() {
  ...
  if (central) {
    ...
    while (central.connected()) {
      ...
      Serial.println("");
      Serial.print("Sensor"); Serial.print("\t"); Serial.print("1");
      Serial.print("\t"); Serial.print("2"); Serial.print("\t"); Serial.print("3");
      Serial.println("");
      Serial.print("\t"); Serial.print(v1); Serial.print("\t"); Serial.print(v2);
